...
<section class="main">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form method="POST" class="form" action="{{ route('payment.viaAccount') }}">
                    @csrf
                    <p>Amount</p>
                    ...
                    <p>Merhcant's Account #</p>
                    <input name="account_number" type="text" id="account_number" placeholder="" class="place1" required>
                    <div class="alert-container">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <button class="btn2" id="btn_Account" type="button">Verify Merchant's Account #</button>
                    </div>
