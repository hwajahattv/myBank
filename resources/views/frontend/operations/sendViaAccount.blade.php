...
<section class="main">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form method="POST" class="form" action="{{ route('send.viaAccount') }}">

                    @csrf
                    <p>Amount</p>
                    <input type="text" name="amount" placeholder="$1000" class="place1" class="" required>
                    ...
                    <p>Receiver's Account #</p>
                    <input name="account_number" type="number" id="account_number" placeholder="Digits only" class="place1" required>

                    <div class="alert-container">

                        @error('account_number') <div class="alert alert-danger ">{{ $message }}</div>
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <button class="btn2" id="btn_Account" type="button">Verify Receiver's Account #</button>
