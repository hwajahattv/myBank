...
<section class="main">
    <div class="container">
        <div class="row">
                ...
                <a href="" class="dashboard-button">
                    <div class="left">
                        <ul class="left-without_border">
                            ...
                            <li class="money">Send via Scan</li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="{{route('send.viaMobile')}}" class="dashboard-button">
                    ...
                    <div class="left">
                        <ul class="left-without_border">
                            ...
                            <li class="money">Send via Mobile Number</li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="{{route('send.viaEmail')}}" class="dashboard-button">
                    ...
                    <div class="left">
                        <ul class="left-without_border">
                            ...
                            <li><i class="fa fa-paper-plane" aria-hidden="true"></i></li>
                            <li class="money">Send via Email</li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="{{route('send.viaAccount')}}" class="dashboard-button">
                    <div class="left">
                        <ul class="left-without_border">
                            <li><i class="fa fa-paper-plane" aria-hidden="true"></i></li>
                            <li class="money">Send via Account Number</li>
