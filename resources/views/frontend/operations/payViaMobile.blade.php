...
<section class="main">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form method="POST" class="form" action="{{ route('payment.viaMobile') }}">
                    ...
                    <p>Merhcant's Mobile #</p>
                    <input name="phone_no" type="number" id="mobile" class="place1" required>
                    <div class="alert-container">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <button class="btn2" id="btn_phone" type="button">Verify Merchant's Mobile</button>
                    </div>
