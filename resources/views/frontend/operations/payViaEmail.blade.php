...
<section class="main">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form method="POST" class="form" action="{{ route('payment.viaEmail') }}">
                    @csrf
                    <p>Amount</p>
                    ...
                    <p>Merhcant's Email</p>
                    <input name="email" type="email" id="email" placeholder="Merchant's Email" class="place1" required>
                    <div class="alert-container">
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <button class="btn2" id="btn" type="button">Verify Receiver's Email</button>
                    </div>
