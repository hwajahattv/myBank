            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data">
                    ...
                    <div class="content">
                        <a href="{{route('request.show',['id'=>$request->id])}}">
                            <ul>
                                ...
                                <li>
                                    <p>$ {{$request->amount}} requested by {{$request->originator_email}} with {{$request->originator_account_number}}<br> </p>
                                </li>
                            </ul>
                        </a>
                    ...
                    <div class="alert alert-success" style="height: 400px">
                        <span class="text-center display-5"> No requests available.</span>
                    </div>
                    @endif
